  ...
  public: {
    Tables: {
      ...
      ai_performance_analysis: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_performance_analysis_attempt_id_fkey"
            columns: ["attempt_id"]
            isOneToOne: true
          ...
          {
            foreignKeyName: "ai_performance_analysis_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      study_progress: {
        ...
        Relationships: [
          {
            foreignKeyName: "study_progress_analysis_id_fkey"
            columns: ["analysis_id"]
            isOneToOne: false
            referencedRelation: "ai_performance_analysis"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      ...
      get_recent_test_submissions: { Args: { p_limit?: number }; Returns: Json }
