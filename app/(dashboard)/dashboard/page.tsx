 ...
 * - Progressive content loading prioritized by importance
 * - Cached catalog data for fast subject navigation
 * - Personalized content that hydrates last without blocking the UI
 * 
 * This approach eliminates the previous full-page skeleton that blocked
 * all content behind the slowest database query.
 */
...
/* ---- Header Region (personalized: entry test selector + user name) ---- */
...
/* ---- Hero Region (personalized: welcome message + activity stats) ---- */
...
/* ---- Subjects Region (cached catalog data — optimized for navigation speed) ---- */
