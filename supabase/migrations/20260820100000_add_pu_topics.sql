-- =====================================================================
-- PU Lahore Topics/Chapters Setup
-- Creates topic hierarchy for all 5 subjects based on CSV structure
-- =====================================================================
...
-- =====================================================================
-- 2. Quantitative Reasoning Topics
-- =====================================================================
INSERT INTO topics (external_id, subject_id, parent_topic_id, kind, title, slug, display_order)
...
SELECT 
  ...
  STRING_AGG(t.title, ', ' ORDER BY t.display_order) as topics
FROM subjects s
LEFT JOIN topics t ON t.subject_id = s.id AND t.external_id LIKE 'pu-%'
WHERE s.slug IN ('verbal-reasoning', 'quantitative-reasoning', 'computer-science', 'mathematics', 'physics')
